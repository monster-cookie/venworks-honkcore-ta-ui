...
- Never package a marker or stale auxiliary movie; `createPackages.ps1` must verify the selected production auxiliary hash before Archive2 mutates an archive.
