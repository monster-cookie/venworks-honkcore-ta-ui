...
in its normal or large HUD movie. Minimalist composes its open holographic
surfaces from groups, text, shapes, dividers, meters, radar rings, markers, and
the remaining specialized components.
