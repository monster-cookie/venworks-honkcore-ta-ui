...
in its normal or large HUD movie. Its layout and six source fragments are
resolved and embedded at build time, so its movies also omit the runtime layout
and palette loader classes. Minimalist composes fitted holographic surfaces
from groups, text, translucent native rectangle and ellipse shapes, dividers,
