package venworks.cui
{
   ...
   public final class CUILayoutEngine
   {
      ...
      public function CUILayoutEngine(param1:DisplayObjectContainer, param2:XML)
      {
         super();
         rootLayer = param1;
         rootSafeRect = this.createRootSafeRect(param2);
      }
      ...
      private function createRootSafeRect(param1:XML) : Rectangle
      {
         ...
         {
            topLeft = rootLayer.globalToLocal(visible.topLeft);
            bottomRight = rootLayer.globalToLocal(visible.bottomRight);
